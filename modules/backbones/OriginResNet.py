...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, layer_st=2, layer_ed=-1, num_classes=1000):
        self.inplanes = 64
...
if __name__ == "__main__":
    ...
    model = resnet18(pretrained=False, layer_st=2, layer_ed=6)
    model = model.to(device)

    out_list = model.forward(t_img)
    for i in out_list:
        print(i.shape)
